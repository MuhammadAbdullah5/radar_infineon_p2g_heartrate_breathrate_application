...
typedef struct
{
    const float*     sample_doppler_data;    /**< The buffer containing the*/

    const float*     sample_fd_data;         /**< The buffer containing the
                                                  radar frequency data */
    const float*     sample_data;            /**< The buffer containing the
                                                  radar time domain data */
    uint32_t         range_fft_len;          /**< The running number of the */
    uint32_t         doppler_fft_len;          /**< The running number of the */
